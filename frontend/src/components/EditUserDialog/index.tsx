...
export function EditUserDialog({ user, canEditRole, onUpdated }: EditUserDialogProps) {
  ...
  return (
    <>
      <Button variant="secondary" onClick={() => setOpen(true)}><Pencil size={18} />Editar dados</Button>
      <Dialog
        open={open}
        onOpenChange={setOpen}
        title="Editar usuário"
        description={canEditRole ? 'Atualize dados pessoais e nível de acesso.' : 'Atualize seus dados pessoais.'}
        footer={(
          <>
