    ...
    <div className={styles.page}>
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <p>
            Centralize usuários e endereços com segurança, consistência e consulta inteligente de
            CEP.
          </p>
          <div className={styles.feature}>
            <ShieldCheck />
            <span>
              <strong>Acesso por perfil</strong>Permissões garantidas pela API
            </span>
          </div>
          <div className={styles.feature}>
            <LockKeyhole />
            <span>
              <strong>Dados protegidos</strong>Autenticação com token e senha criptografada
            </span>
          </div>
        </div>
      ...
      <main className={styles.panel}>
        <form className={styles.form} onSubmit={submit}>
          <div>
            <span className={`${styles.eyebrow} ${styles.eyebrowBrand}`}>Bem-vindo</span>
            <h2>Acesse sua conta</h2>
            <p>Use CPF e senha cadastrados.</p>
          </div>
