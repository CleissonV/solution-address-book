...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> handleDomain(DomainException exception) {
        return response(
                statusFor(exception.getCode()), exception.getCode(), exception.getMessage(), null);
    }
    ...
    ResponseEntity<ApiError> handleConflict() {
        return response(
                HttpStatus.CONFLICT,
                "DATA_CONFLICT",
                "Dados em conflito com um cadastro existente.",
                null);
    }
    ...
    ResponseEntity<ApiError> handleMissingRequestValue() {
        return response(
                ...
                "Parte obrigatoria da requisicao nao informada.",
                null);
    }
